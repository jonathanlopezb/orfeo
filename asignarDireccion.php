 ...
 */
	...
	$municipios = array();
	global $anexCodi;
	$muniCodi = (isset($HTTP_POST_VARS["municipio"]["codigo"])) ?
				$HTTP_POST_VARS["municipio"]["codigo"] : null;
	$direccion = (isset($HTTP_POST_VARS["radicado"]["direccion"])) ? 
				$HTTP_POST_VARS["radicado"]["direccion"] : null;
	$dptoCodi = (isset($HTTP_POST_VARS["departamento"]["depto_codi"])) ?
				$HTTP_POST_VARS["departamento"]["depto_codi"] : null;
	$anexCodi = (isset($HTTP_POST_VARS["anexo"])) ?
				$HTTP_POST_VARS["anexo"] : null;
