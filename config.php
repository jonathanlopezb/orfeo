...
$entidad= "CCO";        //Acronimo de la empresa
$entidad_largo= 'Comisión Colombiana del Océano';  //Variable usada generalmente para los
...
$ambiente = "orfeo";          // Variable que indica el ambiente de trabajo: desarrollo,prueba,orfeo
