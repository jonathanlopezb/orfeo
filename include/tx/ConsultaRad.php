...
// Bloque de atributos que corresponden a los campos de la tabla anexos
    ...
    function idRadicado($radicado) {
        $q = "select RADI_NUME_RADI from radicado where RADI_NUME_RADI='$radicado' ";
        $rs = $this->db->query($q);
        $idRad = 0;
        if (!$rs->EOF) {
    ...
    function subserieRadicado($radicado) {
        ...
        if ($rs->EOF) {
            ...
            $subserieRadicado = $rs->fields['SUBSERIE'];
        }
    ...
    function tipoDocRadicado($radicado) {
        ...
        if ($rs->EOF) {
            ...
            $tipoDocRadicado = $rs->fields['TIPO_DOCUMENTO'];
        }
