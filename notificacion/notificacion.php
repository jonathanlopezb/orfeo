...
<form name=form_notificacion  method='post' action='notificacion_registro.php?<?=session_name()?>=<?=trim(session_id())?>&krd=<?=$krd?>&verrad=<?=$verrad?><?="&mostrar_opc_envio=$mostrar_opc_envio&nomcarpeta=$nomcarpeta&carpeta=$carpeta&leido=$leido"?>'>
...
<table border=0 width 100% cellpadding="0" cellspacing="5" class="borde_tab" >
  ...
  <table border=0 width 100%     >
    <tr> 
      ...
      <td width="317"> 
        <input name="notificador" type="text"  class="tex_area"   size="56"  value = "<?=$tNotNotifica ?>" >
      </td>
    </tr>
    <tr> 
      <td width="121" class="titulos2">Notificado </td>
      <td width="317"> 
        <input name="notificado" type="text"  class="tex_area" size="56" value = "<?=$tNotNotificado ?>"  >
      </td>
    </tr>
    <tr> 
      <td width="121" class="titulos2">Observaciones </td>
      <td width="317"> 
        <input name="observaciones" type="text"  class="tex_area" size="56" value = "<?=$tNotObserva ?>"  >
      </td>
    </tr>
  </table>
