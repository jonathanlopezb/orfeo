...
<table BORDER=0  cellpad=2 cellspacing='2' WIDTH=98%  align='center' style="margin-top: 4px;margin-bottom: 4px;" class="borde_tab" cellpadding="2">
    ...
    <form name=formListado action='../envios/paramListaImpresos.php?<?= $encabezado ?>' method=post> 
        <td width='50%' align='left' height="30" class="titulos2" ><img src="<?= $url_raiz ?>/<?= $imagenes ?>/estadoDocInfo.gif" height="30" alt="Convencion de imagen de tabla de resultados, dividida en 4 de izquierda a derecha anexado, radicado, impreso, enviado">
        </td>
