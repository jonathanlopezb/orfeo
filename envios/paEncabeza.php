        ...
        <tr class="info">
            ...
            <td width="35%">
                <table width="100%" border="0" cellspacing="5" cellpadding="0" id="deps">
                    ...
                    <tr>
                        <form name=formboton action='<?php if (isset($pagina_actual)) $pagina_actual ?>?<?= session_name() . "=" . session_id() ?>&estado_sal_max=<?= $estado_sal_max ?>&pagina_sig=<?= $pagina_sig ?>&dep_sel=<?= $dep_sel ?>&nomcarpeta=<?= $nomcarpeta ?>' method='GET'>
