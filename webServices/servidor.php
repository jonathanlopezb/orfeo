...
$server->register('UploadFile', //nombre del servicio                 
        ...
        'rpc', //Estilo
        'encoded', 'Upload a File'
);
$server->register('getUsuarioCorreo', array(
    'correo' => 'xsd:string'
        ), array('return' => 'tns:Vector'), $ns
);
...
$server->register('darUsuario', array(), array('return' => 'tns:Matriz'), $ns
);

//Servicio que entrega un usuario especifico de Orfeo
$server->register('darUsuarioSelect', array(
    'usuaEmail' => 'xsd:string',
    'usuaDoc' => 'xsd:string'
        ), array('return' => 'tns:Vector'), $ns
);

$server->register('solicitarAnulacion', array(
    'radiNume' => 'xsd:string',
...
$server->register('radicarDocumento', array(
    'file' => 'xsd:base64binary', //archivo en base 64
    'fileName' => 'xsd:string',
    'correo' => 'xsd:string',
    ...
    'return' => 'xsd:string'
        ), $ns, $ns . "#radicarDocumento", 'rpc', 'encoded', 'Radicacion de un documento en Orfeo'
);


//Servicio para anular radicacion de Orfeo
$server->register('anularRadicado', array(
    ...
    'return' => 'xsd:string'), $ns, $ns . "#anularRadicado", 'rpc', 'encoded', 'Anular radicacion de un documento en Orfeo'
);


$server->register('anexarExpediente', array(
    ...
    'return' => 'xsd:string'
        ), $ns, $ns . "#anexarExpediente", 'rpc', 'encoded', 'Anexar un radicado a un expediente'
);

$server->register('cambiarImagenRad', array(
    'numRadicado' => 'xsd:string',
    'ext' => 'xsd:string',
    'file' => 'xsd:base64binary'
        ), array(
    'return' => 'xsd:string'
        ), $ns, $ns . "#cambiarImagenRad", 'rpc', 'encoded', 'Cambiar imagen a un radicado'
);

$server->register('cambiarImagenCorreo', array(
    'numRadicado' => 'xsd:string',
    'texto' => 'xsd:string'
        ), array(
    'return' => 'xsd:string'
        ), $ns, $ns . "#cambiarImagenCorreo", 'rpc', 'encoded', 'Cambiar imagen de un correo radicado'
);


$server->register('getInfoUsuario', array(
    'usuaLoginMail' => 'xsd:string'
        ), array(
    'return' => 'tns:Vector'
        ), $ns, $ns . '#getInfoUsuario', 'rpc', 'encoded', 'Obtener informacion de un usuario a partir del correo electronico'
);

$server->register('asociarObjetoFlujo', array(
    'nuRad' => 'xsd:string',
    'usuaEmail' => 'xsd:string',
    'tflujo' => 'xsd:string'
        ), array(
    'return' => 'xsd:string'
        ), $ns, $ns . '#asociarObjetoFlujo', 'rpc', 'encoded', 'Asociar un objeto a un flujo'
);
$server->register('cambioDeEtapaFlujo', array(
    'objDoc' => 'xsd:string',
    'flujo' => 'xsd:string',
    'etapa' => 'xsd:string'
        ), array(
    'return' => 'xsd:string'
        ), $ns, $ns . '#cambioDeEtapaFlujo', 'rpc', 'encoded', 'Cambio de etapa en un flujo'
);
$server->register('informacionJefe', array(
    'usuaEmail' => 'xsd:string'
        ), array(
    'return' => 'tns:Vector'
        ), $ns, $ns . '#informacionJefe', 'rpc', 'encoded', 'Informacion del Jefe de un usuario'
);
$server->register('radicarCorreo', array(
    ...
    'return' => 'xsd:string'
        ), $ns, $ns . '#radicarCorreo', 'rpc', 'encoded', 'Radicacion de tercer correo'
);

$server->register('asociarExpCorreo', array(
    'idEmpresa' => 'xsd:string',
    'tipoServ' => 'xsd:string',
    'tamPres' => 'xsd:string',
    'radicado' => 'xsd:string'
    ...
    'return' => 'xsd:string'
        ), $ns, $ns . '#asociarExpCorreo', 'rpc', 'encoded', 'Asociar a expediente tercer correo'
);
...
$server->wsdl->addComplexType(
        'Matriz', 'complexType', 'array', '', 'SOAP-ENC:Array', array(), array(
...
$server->wsdl->addComplexType(
        'Vector', 'complexType', 'array', '', 'SOAP-ENC:Array', array(), array(
...
function radicarCorreo($idEmpresa, $correo, $asu, $usuario) {
    ...
    return
            radicarDocumento(
            $file, $fileName, $correo, $destinario, $predio, $esp, $asu, $med, $ane, $coddepe, $tpRadicado, $cuentai, $radi_usua_actu, $tip_rem, $tdoc, $tip_doc, $carp_codi, $carp_per
    );
}
