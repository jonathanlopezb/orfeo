<?php
include_once '/var/www/conf-orfeo/instalacion/db/conexion.php';
if(file_exists('/var/www/conf-orfeo/config.php')){include_once '/var/www/conf-orfeo/config.php';}
include_once ('/var/www/conf-orfeo/instalacion/functions/funciones.php');
    ...
    <form class="form-horizontal" role="form" method="POST" name="configRoot" id="configRoot">
        <div class="container">
		    ...
		    <div class="row">
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label class="col-md-6 control-label">Puerto BD :</label>
		   ...
		   <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
		    ...
		    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
				...
				<span id='mensaje' style="display:none; color:red;">Las contraseñas no coninciden</span>
                        </div>
                    </div>
		   </div>
		  ...
		  <div class="row">
		   ...
		   <div class="row">
                    ...
                    <legend>Datos para crear base de datos.</legend>
		    ...
		    <div class="form-group col-xs-10 col-sm-4 col-md-3 col-lg-3">
				...
				<span id='mensaje1' style="display:none; color:red;">Las contraseñas no coninciden</span>
                        </div>
                    </div>
		    </div><br>
                    <legend>Servidor de correo electronico.</legend>
		...
		<div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4 correo" style="display:none;">
		   ...
		   <div class="row2">
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4 correo" style="display:none;">
                        <label class="col-md-8 control-label">Puerto EMAIL SMTP :</label>
                        <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
...
<div class="row2">
		    ...
		    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4" style='display:none'>
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4" style='display:none'>
                        <label class="col-md-9 control-label">Serv documentos :</label>
                        <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-tasks"></i></span>
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4" style='display:none'>
                        <label class="col-md-8 control-label">Logo superior Orfeo :</label>
                        <div class="col-md-12 selectContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-hdd"></i></span>
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label class="col-md-10 control-label">Long codigo dependencia :</label>
                        <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
				...
				<select name="longitud_codigo_dependencia" class="form-control" id="longitud_codigo_dependencia">
                                    <?php 
				      if ($longitud_codigo_dependencia == 3) { $longitud3 = 'selected';} else { $longitud4 = 'selected';} ?>
                                    <option value="3" <?php $longitud3 ?>>3 Digitos</option>
                                    <option value="4" <?php $longitud4 ?>>4 Digitos</option>
                                </select>
                            </div>
                        </div>
                    </div>
			        ...
			        <select name="tipoRadicadoPqr" class="form-control" id="tipoRadicadoPqr">
                                    <?php
                                      if ($tipoRadicadoPqr == 2) { $longitud2 = 'selected';} else { $longitud4 = 'selected';} ?>
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label class="col-md-10 control-label">Dep radica WEB :</label>
                        <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                    ...
                    <div class="form-group col-xs-10 col-sm-4 col-md-4 col-lg-4">
                        <label class="col-md-10 control-label">Usuario recibe WEB :</label>
                        <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                ...
                fields: {
                    ...
                    servidor_mail_smtp: {
                        validators: {
                            stringLength: {
                                min: 2,
                                max: 30,
                                message: 'Min 2 caracteres y no mas de 30'
                            },
                        }
                    },
                    puerto_mail_smtp: {
                        validators: {
                            stringLength: {
                                min: 2,
                                max: 4,
                                message: 'Min 2 caracteres y no mas de 4'
                            },
                        }
                    },
                    cuenta_mail: {
                    ...
                    servProcDocs: {
                        validators: {
                            stringLength: {
                                min: 4,
                                max: 20,
                                message: 'Min 2 caracteres y no mas de 20'
                            },
                        }
                    },
                    MODULO_RADICACION_DOCS_ANEXOS: {
                        validators: {
                            stringLength: {
                                min: 1,
                                max: 1,
                                message: 'Min 2 caracteres y no mas de 1'
                            },
                            notEmpty: {
                    ...
                    administrador: {
                        validators: {
                            stringLength: {
                                min: 2,
                                max: 50,
                                message: 'Min 2 caracteres y no mas de 50'
                            },
                            notEmpty: {
                                message: 'Correo administrador.'
                            }
                        }
                    },
                    ESTILOS_PATH: {
                    ...
                    imagenes2: {
                        validators: {
                            ...
                            notEmpty: {
                                message: 'Ruta de las imagenes 2.'
                            }
                        }
                    },
                    dependenciaPruebas: {
                        validators: {
                            ...
                            notEmpty: {
                                message: 'Codigo dependencia Pruebas.'
                            }
                        }
                    },
                    tipoRadicadoPqr: {
                        validators: {
                            ...
                            notEmpty: {
                                message: 'Codigo del tipo radicado.'
                            }
                        }
                    },
                    longitud_codigo_dependencia: {
                        validators: {
                            ...
                            notEmpty: {
                                message: 'Largo codigo dependencia.'
                            }
                        }
                    },
