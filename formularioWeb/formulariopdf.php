...
$pdf->SetFont('Arial','',7);
$pdf->Text(110,48,textoPDF("Consulte el estado de su tr&aacute;mite en nuestra p&aacute;gina web "));
$pdf->Text(135,51,textoPDF("C&oacute;digo de verificaci&oacute;n: " . $_SESSION['codigoverificacion']));
...
$pdf->Text(12,67,textoPDF("Bogota D.C, ".date('d')." de ".nombremes(date('m'))." de ".date('Y')));
