...
values ('$numeroRadicado', to_date('" . date('d') . "/" . date('m') . "/" . date('Y') . "','DD/MM/RR HH24:MI:SS')," . $_SESSION['tipo'] . ",3," . $_SESSION['codigo_orfeo'] . ",to_date('" . date('d') . "/" . date('m') . "/" . date('Y') . "','DD/MM/RR HH24:MI:SS'),'COLOMBIA'," . $_SESSION['muni'] . "," . $carpeta . "," . $_SESSION['depto'] . ",1,'" . $descripcionAnexos . "', ";
...
values('" . $_SESSION['depeRadicaFormularioWeb'] . "',to_date('" . date('d') . "/" . date('m') . "/" . date('Y') . "','DD/MM/RR HH24:MI:SS'),1,'$numeroRadicado','Radicacion P.Q.R.S'," . $_SESSION['usuaRecibeWeb'] . ",'22222222',2,'" . $_SESSION['documento_destino'] . "','" . $_SESSION['depeRadicaFormularioWeb'] . "')";
...
values('" . $numeroRadicado . "','" . $numeroRadicado . sprintf("%05d", ($i + 1)) . "'," . $tipoCodigo . "," . $uploader->sizes[$i] . ",'S','".$rs_login->fields['USUA_LOGIN']."','" . $asuntosNom[$i] . " documento de soporte No. " . $soporNo . "',1,'" . $uploader->nombreOrfeo[$i] . "','N',0,0,0,1,1,'" . $_SESSION["depeRadicaFormularioWeb"] . "',to_date('" . date('d') . "/" . date('m') . "/" . date('Y') . "','DD/MM/RR HH24:MI:SS'),0, $tipo_doc_Codigo)";
...
//    $pdf->Text(100, 54, textoPDF("sigec-inicio/sistema-pqrsyd/consultaWeb/"));
    $pdf->Text(20, 67, textoPDF("Bogotá, " . date('d') . " de " . nombremes(date('m')) . " de " . date('Y')));
