	...
	<div>
		<table width='400px'>			
			...
			while(!$rs->EOF){
				...
				while($ban<5){
					switch($ban){
						case "0": $tipo="NOV_INFOR"; $let="INFORMADO";
						break;
						case "1": $tipo="NOV_REASIG"; $let="REASIGNADO";
						break;
						case "2": $tipo="NOV_VOBO";  $let="VISTO BUENO";
						break;
						case "3": $tipo="NOV_DEV"; $let="DEVUELTO";
						break;
						case "4": $tipo="NOV_ENTR"; $let="ENTRADA";
						break;
					}
