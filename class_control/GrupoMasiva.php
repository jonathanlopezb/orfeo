...
class GrupoMasiva {
    ...
    /**
     * Realiza la transaccci�n de sacar un radicado del grupo de env�o de masiva
     * @param $grupo	string	es el c�digo del radicado del grupo
     * @param $codRadicado	string	es el c�digo del radicado a sacar
     */
    ...
    /**
     * Realiza la transaccci�n de incluir nuevamente un radicado en su grupo de env�o de masiva
     * @param	$grupo	string	es el c�digo del radicado del grupo
     * @param $codRadicado	string	es el c�digo del radicado a incluir
     */
    ...
    /**
     * Obtiene los radicados de un grupo de masiva y pone esta informaci�n en los atributos  vecRads y sgd_renv_codigo
     * @param $dependencia	string	es la dependencia del grupo
     * @param $grupo	string	es el c�digo del radicado del grupo
     * @param $filtro	string	es un subconjunto de radicados, en caso de tratarse de de una b�squeda espec�fica
     * @return   array
     */
    function obtenerGrupo($dependencia, $grupo, $filtro) {
        ...
        //Recorre el resultado de la b�squeda
        while ($rs && !$rs->EOF) {
    ...
    /**
     * Obtiene los radicados de un grupo de masiva que han dido sacados de este y pone esta informaci�n en el atributo grupoSacado
     * @param $grp	string	es el c�digo del radicado del grupo
     * @return   array
     */
    ...
    /**
     * Obtiene el n�mero de radicados de un grupo de masiva que han dido sacados de este; antes deinvocar esta funci�n debe invocarse setGrupoSacado()
     * @return	int
     */
    ...
    /**
     * Obtiene los radicados limite de un grupo de masiva en la posici�n 0 se encuentra el l�mite inferior y en la 1 el superior. Antes de invocar esta funci�n debe llamarse a obtenerGrupo()
     * @return   array
     */
    ...
    /**
     * Obtiene el n�mero de radicados nacionales y locales que existen en un grupo de masiva
     * en los �ndices 'local' y 'nacional'
     * @param $depe_dpto_cod	int	es c�digo del departamento de la dependencia actual
     * @param $depe_muni_cod	int	es el c�digo del municipio de la dependencia actual
     * @return   array
     */
        ...
        while ($i < $num) {
            ...
            if (!$this->radicadoRetirado($this->vecRads[0], $this->vecRads[$i])) {
                ...
                if ($datosRad["contCodi"] == $cont_cod) { //Si va para el mismo continente
                    if ($datosRad["paisCodi"] == $pais_cod) { //Si va para el mismo pais //Hacemos la validacion de si es local, aca hay un codigo metido a machetazo el cual
    ...
    /**
     * Escribe la funci�n de calcular el precio de un grupo de radicados a enviar
     * @return   string
     */
    ...
    /**
     * Obtiene el primer radicado local de un grupo. Antes de invocar esta funci�n debe llamarse a obtenerGrupo()  y a getNumNacionalesLocales()
     * @return   string
     */
    ...
    /**
     * Obtiene el primer radicado nacional de un grupo. Antes de invocar esta funci�n debe llamarse a obtenerGrupo()  y a getNumNacionalesLocales()
     * @return   string
     */
    ...
    /**
     * Obtiene el primer radicado Internacional grupo 1 de un grupo. Antes de invocar esta funci�n debe llamarse a obtenerGrupo()  y a getNumNacionalesLocales()
     * @return   string
     */
    ...
    /**
     * Obtiene el primer radicado Internacional grupo 2 de un grupo. Antes de invocar esta funci�n debe llamarse a obtenerGrupo()  y a getNumNacionalesLocales()
     * @return   string
     */
    ...
    /**
     * Obtiene sgd_renv_codigo() de un grupo. Antes de invocar esta funci�n debe llamarse a obtenerGrupo()  
     * @return   string
     */
