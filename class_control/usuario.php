...
class Usuario {
    ...
    function usuarioDependecina($dependencia, $codUsuario) {
        ...
        if ($rs && !$rs->EOF) {
            //$this->cursor->driver == "mysql" 
            $this->depe_codi = $this->cursor->driver == "mysql" ? $rs->fields['depe_codi'] : $rs->fields['DEPE_CODI'];
            $this->usua_pasw = $this->cursor->driver == "mysql" ? $rs->fields['usua_pasw'] : $rs->fields['USUA_PASW'];
            $this->usua_nomb = $this->cursor->driver == "mysql" ? $rs->fields['usua_nomb'] : $rs->fields['USUA_NOMB'];
            $this->perm_radi = $this->cursor->driver == "mysql" ? $rs->fields['perm_radi'] : $rs->fields['PERM_RADI'];
            $this->usua_nuevo = $this->cursor->driver == "mysql" ? $rs->fields['usua_nuevo'] : $rs->fields['USUA_NUEVO'];
            $this->usua_doc = $this->cursor->driver == "mysql" ? $rs->fields['usua_doc'] : $rs->fields['USUA_DOC'];
            $this->usua_nacim = $this->cursor->driver == "mysql" ? $rs->fields['usua_nacim'] : $rs->fields['USUA_NACIM'];
            $this->usua_email = $this->cursor->driver == "mysql" ? $rs->fields['usua_email'] : $rs->fields['USUA_EMAIL'];
            $this->perm_radi_sal = $this->cursor->driver == "mysql" ? $rs->fields['perm_radi_sal'] : $rs->fields['PERM_RADI_SAL'];
            $this->usu_direccion = $this->cursor->driver == "mysql" ? $rs->fields['usu_direccion'] : $rs->fields['usu_DIRECCION'];
            $this->usu_telefono1 = $this->cursor->driver == "mysql" ? $rs->fields['usu_telefono1'] : $rs->fields['USU_TELEFONO1'];
            $this->usu_telefono2 = $this->cursor->driver == "mysql" ? $rs->fields['usu_telefono2'] : $rs->fields['USU_TELEFONO2'];
            $this->usu_cargo = $this->cursor->driver == "mysql" ? $rs->fields['usu_cargo'] : $rs->fields['USU_CARGO'];
            $this->perm_tipif_anexo = $this->cursor->driver == "mysql" ? $rs->fields['perm_tipif_anexo'] : $rs->fields['PERM_TIPIF_ANEXO'];
            return true;
        } else
            return false;
    }
    ...
    function usuarioDocto($docto) {
        ...
        if ($rs->RecordCount() > 0) {
            ...
            $this->perm_radi_sal = $this->cursor->driver == "mysql" ? $rs->fields['perm_radi_sal'] : $rs->fields['PERM_RADI_SAL'];
            $this->usu_direccion = $this->cursor->driver == "mysql" ? $rs->fields['usu_direccion'] : $rs->fields['USU_DIRECCION'];
            $this->usu_telefono1 = $this->cursor->driver == "mysql" ? $rs->fields['usua_telefono1'] : $rs->fields['USU_TELEFONO1'];
            $this->usu_telefono2 = $this->cursor->driver == "mysql" ? $rs->fields['usua_telefono2'] : $rs->fields['USU_TELEFONO2'];
            $this->usu_cargo = $this->cursor->driver == "mysql" ? $rs->fields['usu_cargo'] : $rs->fields['USU_CARGO'];
            $this->usua_codi = $this->cursor->driver == "mysql" ? $rs->fields['usu_codi'] : $rs->fields['USUA_CODI'];
            $this->perm_tipif_anexo = $this->cursor->driver == "mysql" ? $rs->fields['perm_tipif_anexo'] : $rs->fields['PERM_TIPIF_ANEXO'];
        }
    }
