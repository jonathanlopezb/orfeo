...
if($motivo_devol)
	...
	echo "<br><span class=etexto>Se ha realizado la devoluci�n de los siguientes registros enviados
				<br>";
}
...
{
	echo "<span class=etexto><b> <br>Debe seleccionar un tipo de devoluci�n<br>";
