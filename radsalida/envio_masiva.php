...
include_once "../class_control/GrupoMasiva.php";
...
<html>
    ...
    <body>
        ...
        <form name="form1" method="post" action="envio_masiva_registro.php?<?= session_name() . "=" . session_id() . "&krd=$krd" ?>" class="borde_tab">
            <center>
                <div id="titulo" style="width: 60%;" align="center">Env&iacute;o de documentos - Radicaci&oacute;n masiva</div>
            </center>
            <table border=2 width=60% class=borde_tab cellspacing="5" align="center">
                <tr class=titulos2 align="center" > 
                    <td width="26%" >Grupo</td>
                    <td width="35%" >Empresa de Env&iacute;o</td>
                ...
                <tr class=listado2>
                    ...
                    <td height="26" align="center" width="35%"> 
                        <select name=empresa_envio id=empresa_envio class=select  onClick=" if (this.value != 'null' && envio_peso.value.length > 1)
                      calcular_precio('empresa_envio', 'envio_peso', 'valor_gr');" >
