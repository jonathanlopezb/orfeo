...
$grupo = $radGrupo;
//inicializa el arreglo que contendr� los datos del grupo de radicados
$data = array();
...
//Varible que almacena la fecha en la que se radic� el grupo de masiva
...
//si se seleccion� el grupo de radicados
if (trim(strlen($grupo))) {
    ...
    //almacena el n�mero de radicados pertenecientes al grupo
    $num = count($radsGrupo);
    $i = 0;
...
<body>
    ...
    <form action="menu_masiva.php?<?= $params ?>" name="formMensaje">
        <center>
            <div id="titulo" style="width: 53%;" align="center">Resultado de la consulta</div>
            <table width="53%" align="center" border=1 border=0 cellpadding=0 cellspacing=5 class='borde_tab'>
                <tr align="center"> 
                    <td height="118" colspan="2" class="listado2" align="center">
                        <input type="hidden" name="krd" value="<?= $krd ?>">
                        <input type="hidden" name="params" value="<?= $params ?>">
                        <table width="100%" border="0" cellpadding="2" cellspacing="0">
                            <tr align="left"> 
                                <td height="84" class="listado2" >Se ha generado el archivo con el grupo <?= $grupo ?>, recuperado.<br>
                                    <br>
