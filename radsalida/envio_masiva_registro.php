...
<html>
    ...
    <form name="form1" method="post" action="cuerpo_masiva.php?<?= session_name() . "=" . session_id() . "&krd=$krd" ?>" class="borde_tab">
        <?php
//almacena el query	
        $isql = "UPDATE SGD_RENV_REGENVIO SET sgd_renv_tipo = '2',depe_codi='$dependencia',sgd_fenv_codigo='$empresa_envio'
		WHERE sgd_renv_planilla is NULL and sgd_renv_tipo = 1 and radi_nume_grupo = '$grupo' and radi_nume_sal not in 
...
//Si existen documentos internacionales grupo2										
        ...
        <center>
            <div id="titulo" style="width: 43%;" align="center">Confirmaci&oacute;n del env&iacute;o - radicaci&oacute;n masiva
