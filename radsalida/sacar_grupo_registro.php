...
/**
 * Programa que registra la transacci�n de edici�n de grupo de radicados de correspondencia masiva, seg�n lo seleccionado en lista_sacar_grupo.php 
...
//Si no est� registrada la dependencia recupera la sesi�n
...
//n�mero de radicados que fueron seleccionados de la lista
$num = count($check_value);
$i = 0; 
$grupoMas = & new GrupoMasiva($db);
//Esta variable almacenar� todos los radicados chequeados en el formulario enviado
$retirTodos="";
//Guardar� los radicados nuevos a retirar
$retirNueva="";
$fechaHoy = Date("Y-m-d");
?>
<html>
