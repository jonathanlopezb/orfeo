...
$sql_nomExp = "select sgd_exp_numero as EXP_NUMERO from sgd_sexp_secexpedientes where upper(sgd_sexp_parexp1) like '$q' and depe_codi='$dependencia'";
//echo $sql_nomExp;

$rs=$db->query($sql_nomExp);
//error_log('------------------- '.$sql_nomExp);
