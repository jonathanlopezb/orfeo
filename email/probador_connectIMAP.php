...
// if(imap_open ('{'.$servidor_mail.':'.$puerto_mail.'/imap/ssl/novalidate-cert/notls}INBOX', $usuario, $contrasena)) {
...
$connection="imap://$usuario:$contrasena@$servidor_mail:$puerto_mail/INBOX#novalidate-cert";
