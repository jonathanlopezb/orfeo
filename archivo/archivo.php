...
<!--                    <tr>
                    ...
                    <tr>
                        <td class=listado1>
                            <span class="leidos2"><a href='alerta.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="vinculos"><b>4.Transferencias documentales (Expedientes)</a></td>
                    </tr>
                    <!--
                    <tr>
                      <td class="listado2">
                        <span class="leidos2"><a href='<?php print $dir_raiz; ?>/archivo/busqueda_central.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="menu_princ"><b>9.Busqueda Archivo Central</a>  </td>
                    </tr>
                    <tr>
                      <td class="listado2">
                        <span class="leidos2"><a href='<?php print $dir_raiz; ?>/archivo/insertar_central.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="menu_princ"><b>10.Insertar Archivo Central</a>  </td>
                    </tr>
                    -->
                    <!--
                        /**
                    ...
                    if ($usua_perm_archi == 2) {
                        ...
                        <tr>
                            <td class="listado2">
                                <span class="leidos2"><a href='../archivo/adminEdificio.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="vinculos"><b>5.Administracion de Edificios</a></td>
                        </tr>
                    <? } ?>
                    <!--
                    <tr>
                      <td class="listado2">
                        <span class="leidos2"><a href='<?php print $dir_raiz; ?>/archivo/tvd/menu_tvd.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="menu_princ"><b>12.Administracion de TVD</a>  </td>
                    </tr>
                    <tr>
                      <td class="listado2">
                        <span class="leidos2"><a href='<?= $dir_raiz ?>/archivo/menu_fondos.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&$orno&adodb_next_page" ?>' target='mainFrame' class="menu_princ"><b>13. Fondos documentales</a>  </td>
                    </tr>
                    -->
                </table>
   <center>
