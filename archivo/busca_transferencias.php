...
if (!$queryAlertaw)
    $queryAlertaw = $queryCont;

$query_cont = 'select disp_fin, estado,dias_ag,dias_ac,count(*) AS conteo from (' . $queryAlertaw . ') AS A 
                where dias_ag < 0 group by disp_fin, estado, dias_ag,dias_ac';
