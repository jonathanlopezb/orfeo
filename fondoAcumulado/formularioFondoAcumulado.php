...
<html>
    ...
    <body>
        <div class="container">
            <nav class="navbar navbar-default" role="navigation" style="background-color: #8F0000;">
                <div class="navbar-header">
                    <a class="navbar-brand" style="color: #FFF;" href="#"><b>Fondo Acumulado</b></a>
                </div>
            </nav>
            <div class="row">
                    ...
                    <div class="well well-sm">
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-md-9 section-box">
                                ...
                                <p>
                                    Quieres activar el módulo de fondo acululado?
                                </p>
                                <p>
                                    Contáctanos.
                                </p>
