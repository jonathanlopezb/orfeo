...
$numRadi = $_POST['numRadi'];
$tipVinDocto = $_POST['tipVinDocto'];
//$verrad = $_GET['verrad'];
$codusuario = $_GET['codusuario'];
$dependencia = $_GET['dependencia'];
$insertar_registro = $_POST['insertar_registro'];
    ...
    <body bgcolor="#FFFFFF">
        <form method="post" action="<?= $encabezadol ?>" name="VincDocu"> 
            ...
            if ($insertar_registro && $numRadi != '') {
                ...
                $isqlBradi = "select * FROM RADICADO where RADI_NUME_RADI = '$numRadi'";
                $rsBradi = $db->query($isqlBradi);
//                echo '********************* '.$isqlB;
                $numRadiBusq = $rsBradi->fields["RADI_NUME_RADI"];
                echo '..... '.$rsBradi->fields["RADI_NUME_RADI"].' ..... '.$rsBradi->fields["radi_nume_radi"];
                if ($numRadiBusq == '') {
                    ...
                    if ($tipVinDocto == 0) {
                        ...
                        $isqlM = "select * FROM RADICADO where RADI_NUME_RADI = '$verrad'";
                        $rsM = $db->query($isqlM);
    ...
    <!--	<table border=0 width=70% align="center" class="borde_tab" cellspacing="0">
            ...
            <center>
                <table width="75%" border="1" cellspacing="1" cellpadding="0" align="center" class="borde_tab">
                    <tr>
                    <div id="titulo" style="width:75%;" align="center">Vinculación documentos</div>
                    </tr>
                    <tr>
                ...
                <table border=0 width=75% align="center" class="borde_tab">
                    ...
                    <center><input name="insertar_registro" type=submit class="botones_mediano" value="Grabar Cambio "></center></TD>
                    <td width="33%"height="25">
                    <center><input name="actualizar" type="button" class="botones_mediano" id="envia23" onClick="procModificar();"value=" Busqueda 1 "></center></TD>
                    <td width="33%" height="25">
                    <center><input name="aceptar" type="button" class="botones_mediano" id="envia22" onClick=" opener.regresar();window.close();"value=" Cancelar "></center></TD>
                    </tr>
                </table>
                <table width="75%" border="0" cellspacing="1" cellpadding="0" align="center" class="borde_tab">
                    <tr align="center">
                        <td>
                            <?php
//                            echo '--------------'.$verrad;
                            include_once "$dir_raiz/vinculacion/lista_tiposVinculados.php";
                            ?>
                        </td>
                    </tr>
                </table>
