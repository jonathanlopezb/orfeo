...
<?php Search_show() ?>
   ...
   <td valign="top"><font class="FieldCaptionFONT"><a href="busquedaHist.php?<?=session_name()."=".session_id()."&fechah=$fechah" ?>">B�squeda por hist�rico</a><br><a href="busquedaUsuActu.php?<?=session_name()."=".session_id()."&fechah=$fechah" ?>">Reporte por Usuarios</a></font></td>
  </tr>
 </table>
 <table>
  <tr>
