...
if (strlen($niv)) {
    ...
    $result = $db->query("SELECT depe_codi, depe_nomb FROM dependencia");
    ...
    # Lista de tipos de radicado
    $result = $db->query("SELECT sgd_trad_codigo, sgd_trad_descr FROM sgd_trad_tiporad");
    
    while (!$result->EOF) {
        $tiposradicados[] = $result->fields;
        $result->MoveNext();
    }


    # Lista de tipos documental -> rol tipo documental
    $result = $db->query("SELECT sgd_tpr_codigo, sgd_tpr_descrip FROM sgd_tpr_tpdcumento");

    while (!$result->EOF) {
        $tipodocumental[] = $result->fields;
        $result->MoveNext();
    }

    # Lista estados
    $result = $db->query("SELECT esta_codi, esta_desc FROM estado");

    while (!$result->EOF) {
        $tiposestados[] = $result->fields;
        $result->MoveNext();
    }

    // print_r($tiposdependencias);
    // print_r($tiposradicados);
    // print_r($roltipodocumental);
    // print_r($tipodocumental);
    // print_r($tiposestados);
    // die();
...
<html>
    ...
    <?php 
        /***
         * 
         *  Cuando se de clic en la opción anterior se debe mostrar un formulario de consulta donde se muestren los siguientes datos: 
         * 
         *  Número de Radicado, 
         *  Asunto del Radicado, 
         *  Número Expediente,    
                ...
                <form id="form-filter" name="Search">
                    ...
                    <div id="titulo2" class="container-principal">
                        ...
                        <div class="grid-container">
                            ...
                            <div class="seccion1">
                                <div class="seccion1-col1"> 

                                    <section>
                                        <label class="label-filter"> Número de Radicado </label>
                                        <input class="ml-2 input-form" type="text" id="radi_nume_radi" value="" placeholder="Ingrese el número de radicado" name="radi_nume_radi">
                                    </section>
                                    
                                    <section>
                                        <label class="label-filter">  Nombre del Expediente </label>
                                        <input class="ml-2 input-form" type="text" id="sgd_sexp_parexp1" value="" placeholder="Ingrese el nombre de expediente" name="sgd_sexp_parexp1">
                                    </section>

                                    <section>
                                        <label class="label-filter">  Número de Expediente </label>
                                        <input class="ml-2 input-form" type="text" id="sgd_exp_numero" value="" placeholder="Ingrese el nombre de expediente" name="sgd_exp_numero">
                                    </section>

                                    <section>
                                        <label class="label-filter">  Dependencia Actual </label>
                                        <select class="input-form select form-control" name="radi_depe_actu" id="radi_depe_actu">
                                            <option selected disabled>Seleccione una dependencia</option>
                                            <?php  foreach($tiposdependencias as $key => $value){ ?>

                                                <option value="<?= $value['depe_codi'] ?>"><?= $value['depe_codi'].' - '.$value['depe_nomb'] ?></option>
                                ...
                                <div class="seccion1-col2">
                                    ...
                                    <div class="seccion1-col2-div">

                                        <div class="seccion2-col2">
                                            <section>
                                        ...
                                        <div class="seccion2-col2">
                                            <section>
                                                ...
                                                <input class="input-form" type="text" id="sgd_dir_doc" value="" placeholder="Ingrese el número de documento de identidad" name="sgd_dir_doc">
                                            </section>
                                        </div>
                                        ...
                                        <div class="seccion2-col2">
                                            <section>
                                                <label class="label-filter"> Usuario Radicador </label>
                                                <input class="input-form" type="text" id="radi_usua_radi" value="" placeholder="Ingrese el nombre del usuario radicador" name="radi_usua_radi">
                                            </section>
                                        </div>

                                        <div class="seccion2-col2">
                                            <section>
                                                <label class="label-filter"> Usuario Actual </label>
                                                <input class="input-form" type="text" id="radi_usua_actu" value="" placeholder="Ingrese el nombre del usuario actual" name="radi_usua_actu">
                                            </section>
                                        </div>
                            ...
                            <div class="seccion3">
                                <div class="seccion3-col2">
                                    <section>
                                        <label class="label-filter">  Tipo de Radicado </label>
                                        <select style="margin: 5px;" class="input-form select form-control" name="sgd_trad_codigo" id="sgd_trad_codigo">
                                            <option selected disabled>Tipos de radicado</option>
                                            <?php  foreach($tiposradicados as $key => $value){ ?>

                                                <option  value="<?= $value['sgd_trad_codigo'] ?>"><?= $value['sgd_trad_codigo'].' - '.$value['sgd_trad_descr'] ?></option>
                                ...
                                <div class="seccion3-col2">
                                    <section>
                                        <label class="label-filter">  Tipo Documental  </label>
                                        <select style="margin: 5px;" class="input-form select form-control" name="tdoc_codi" id="tdoc_codi">
                                            <option selected disabled>Tipos documental</option>
                                            <?php  foreach($tipodocumental as $key => $value){ ?>

                                                <option  value="<?= $value['sgd_tpr_codigo'] ?>"><?= $value['sgd_tpr_codigo'].' - '.$value['sgd_tpr_descrip'] ?></option>
    ...
    <script src="./datatable/js/documentos.js" type="text/javascript"></script>
