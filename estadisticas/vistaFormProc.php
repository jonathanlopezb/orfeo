...
<script type="text/javascript" src="<?=$dir_raiz?>/js/spiffyCal/spiffyCal_v2_1.js"></script>
...
$datosaenviar = urlencode("fechaf=$fechaf&tipoEstadistica=$tipoEstadistica&codus=$codus&krd=$krd&dependencia_busq=$dependencia_busq&dir_raiz=$dir_raiz&fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&tipoRadicado=$tipoRadicado&tipoDocumento=$tipoDocumento&fechaano=$codAno");
