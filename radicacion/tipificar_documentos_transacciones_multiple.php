...
if (!defined('ADODB_FETCH_ASSOC')) define('ADODB_FETCH_ASSOC',0);
...
if ($borrar)
{		//Modificado skina
		$sqlE = "SELECT cast(radi_nume_radi as varchar(15)) as RADI_NUME_RADI FROM SGD_RDF_RETDOCF b WHERE SGD_MRD_CODIGO =  '$codiTRDEli' $whereFiltro";
