...
{
  window.open("../verradicado.php?verrad=<?=$nurad?>&<?=$var_envio?>","Modificaci�n_de_Datos","height=700,width=650,scrollbars=yes");
  
}
</SCRIPT>
<?php
if ((strlen($nurad)-strlen($longitud_codigo_dependencia))==11) $consecutivo =6; else  $consecutivo =5;
$x1=substr($nurad,0,4);
