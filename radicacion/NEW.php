...
if ($Submit3 == "ModificarDocumentos")
    $var_envio = session_name() . "=" . trim(session_id()) . "&ent=$ent&carp_per=$carp_per&carp_codi=$carp_codi&rad=$nurad&depende=$depende&Submit3=$Submit3&depende=$depende";
else
                            ...
                            if ($Submit3 == "Radicar") {
                                ...
                                if ($acceso == 0) {
                                    ...
                                    if (($tipoMedio == "eMail" or $med == 3) && isset($_POST['tipoRadEmail']) && $_POST['tipoRadEmail'] != 0) {
                                        ...
                                        if ($_POST['tipoRadEmail'] == 2) {
                                            $_POST['tipoRadEmail'] = 0;
                                        }
                                    ...
                                    $hist->insertarHistorico($radicadosSel, $dependencia, $codusuario, $coddepe, $radi_usua_actu, " Se radicado correctamente el documento ", $codTx, $result);
