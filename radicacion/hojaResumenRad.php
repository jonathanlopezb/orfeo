...
<?
echo "<center><a class=vinculos href='$arpdf_tmp?fechaf".date("dmYh").time()."'>Abrir Archivo Pdf</a></center></td><td>";
...
{
	$rutaNew = "/". substr($verrad,0,4)."/".substr($verrad,4,$longitud_codigo_dependencia)."/".$nurad.".pdf";
