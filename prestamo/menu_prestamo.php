...
<body class="PageBODY">
   ...
   <form method="post" action="prestamo.php" name="menu"> 
      ...
      <table width="31%" border="1" cellpadding="0" cellspacing="5" class="borde_tab" align="center">
         ...
         <tr>
            <td class="listado2">2. <a class="vinculos" href="javascript:seleccionar(2);">Devoluci&oacute;n de documentos</a></td>   	  
         </tr>
         <tr>
            <td class="listado1">3. <a class="vinculos" href="javascript:seleccionar(0);">Generaci&oacute;n de reportes</a></td>   	  	  
         </tr>
         <tr>
