...
?>
    ...
    <table class="FormTABLE">
     ...
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT"><label for="s_RADI_NUME_RADI">Radicado</label></font></td>
      <td class="DataTD"><input type="text" id="s_RADI_NUME_RADI" name="s_RADI_NUME_RADI" maxlength="" value="<?= tohtml($flds_RADI_NUME_RADI) ?>" size="" title="Ingrese el número o parte del número de radicado" ></td>
     </tr>
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT"><label for="s_USUA_LOGIN_ACTU">Usuario</label></font></td>
      <td class="DataTD"><input type="text" name="s_USUA_LOGIN_ACTU" maxlength="15" value="<?= tohtml($flds_USUA_LOGIN_ACTU) ?>" size="15" title="Campo para ingresar el nombre completo del usuario o parte de él"></td>
     </tr>
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT"><label for="s_DEPE_CODI">Dependencia</label></font></td>
      <td class="DataTD"><select name="s_DEPE_CODI" title="Listado de todas las dependencias existentes">
<?
...
?></select></td>
     ...
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT"><label for="s_PRES_ESTADO">Estado</label></font></td>
      <td class="DataTD"><select name="s_PRES_ESTADO" title="Listado con los posibles estados en que se puede encontrar el documento">
<?
    echo "<option value=\"\">" . $ss_PRES_ESTADODisplayValue . "</option>";
    $LOV = preg_split(";", "1;Solicitado;2;Prestado;3;Devuelto;4;Cancelado;5;Prestamo Indefinido");
...
?></select></td>
     ...
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT"><label for="s_PRES_REQUERIMIENTO">Requerimiento</label></font></td>
      <td class="DataTD"><select name="s_PRES_REQUERIMIENTO" id="s_PRES_REQUERIMIENTO" title="Listado de">
<?
    echo "<option value=\"\">" . $ss_PRES_REQUERIMIENTODisplayValue . "</option>";
    $LOV = preg_split(";", "1;Documento;2;Anexo");
...
?></select></td>
     ...
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT">Fecha Inicial (dia/mes/año)</font></td>
...
?></select></td>
     ...
     <tr>
      <td class="FieldCaptionTD"><font class="FieldCaptionFONT">Fecha final (dia/mes/año)</font></td>
...
//-------------------------------
  ...
  $aPRES_REQUERIMIENTO = preg_split(";", "1;Documento;2;Anexo");
  $aPRES_ESTADO = preg_split(";", "1;Solicitado;2;Prestado;3;Devuelto;4;Cancelado;5:Prestamo Indefinido");
//-------------------------------
//-------------------------------
