...
?>
   ...
   <form method="POST" action="prestamoMasivo.php" name="PRESTAMO">
  ...
  <input type="submit" value="Buscar Documentos Solicitados por este Usuario">
  </td></tr>
  </form>
  </table>
<?
