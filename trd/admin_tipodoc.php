...
include ("$dir_raiz/busqueda/common.php");
//$db->conn->debug = true;
            ...
            <table width="80%" class="borde_tab" cellspacing="1" border="1" align="center">
                ...
                <td align="left" class="listado2">
                    <td align="left" class="listado2">
                        ...
                        <?php
                        if ($tpRadica) {  echo " checked "; $tpRadica = '1';
                        } else { $tpRadica = '0'; }
                        ?> 
...
//Modificacion Datos Tipo Documental
            if ($_POST['modi_tdoc'] && ($detatipod != '') && ($codtdocI != 0)) {
                ...
                if ($radiNumero != '') {
                    ...
                    $query = "update SGD_TPR_TPDCUMENTO set SGD_TPR_DESCRIP ='$detatipod',$cadena SGD_TPR_TERMINO = '$terminot', SGD_TERMINO_REAL = '$terminot',sgd_tpr_radica=$tpRadica, sgd_tpr_estado=1 where  sgd_tpr_codigo = $codtdocI ";
                    //$db->conn->debug = true;
                    $rsIN = $db->conn->query($query);
                    $terminot = '';
                    $detatipod = '';
            ...
            echo $mensaje_err;
            include_once "$dir_raiz/trd/lista_tiposdocu.php";
            ?>
        </form>
       <!-- <p>
        <?php // $mensaje_err  ?>
