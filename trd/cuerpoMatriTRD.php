...
<!--            <table class=borde_tab width='98%' cellspacing="5">
            ...
            <center>
                <div id="titulo" style="width: 99%; " align="center">Documentos asignados a estos par&aacute;metros</div>
            </center>
            <?php
            if (strlen($orderNo) == 0) {
                $orderNo = "1";
        ...
        <center>
            <div id="titulo" style="width: 99%; " align="center">Documentos sin asignar a estos par&aacute;metros</div>
        </center>
        <?php
        if (strlen($orderNo) == 0) {
            $orderNo = "1";
