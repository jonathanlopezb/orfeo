...
{
//by skina no existe la columna estado-empresa $sql_bodega="select NOMBRE_DE_LA_EMPRESA,NIT_DE_LA_EMPRESA from BODEGA_EMPRESAS where (NOMBRE_DE_LA_EMPRESA like '%".strtoupper($_GET['entidad'])."%' or SIGLA_DE_LA_EMPRESA like '%".strtoupper($_GET['entidad'])."%' or NIT_DE_LA_EMPRESA like '%".strtoupper($_GET['entidad'])."%') AND ESTADO_EMPRESA=1";
$sql_bodega="select NOMBRE_DE_LA_EMPRESA,NIT_DE_LA_EMPRESA from BODEGA_EMPRESAS where (NOMBRE_DE_LA_EMPRESA like '%".strtoupper($_POST['entidad'])."%' or SIGLA_DE_LA_EMPRESA like '%".strtoupper($_POST['entidad'])."%' or NIT_DE_LA_EMPRESA like '%".strtoupper($_POST['entidad'])."%') AND ACTIVA=1";
