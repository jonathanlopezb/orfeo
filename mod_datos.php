...
<!--            <tr valign="bottom">       
        ...
        <table  WIDTH=98% align="center" border="1" cellpadding="0" cellspacing="5" class="borde_tab">
            ...
            <tr> 
                ...
                <td class='listado2' width="24%" ><?php
                    $ano_fin = date("Y");
                    $ano_fin++;
                    $ano_fin = $ano_fin - 10;
                    $ano_ini = $ano_fin - 80;
                    ?><select name=usua_dia class="select" aria-label="Lista de dias para la fechas de nacimiento">
                        ...
                        ?>
                    </select><select name=usua_mes class="select" aria-label="Lista de meses del año para seleccionar en fecha de nacimiento">
                    ...
                    </select><select name=usua_ano class="select" aria-label="Listado de años para la fecha de nacimiento">
