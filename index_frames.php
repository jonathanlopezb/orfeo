...
<html>
    <head>
        ...
        <style>
            .menuUserNom {
                background-color: #e18838 !important;
    ...
    <body  style="overflow: hidden;" onload="modalinfo()">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href=""><span class="glyphicon glyphicon-folder-close"></span>
                                <ul class="red" id="submenu2">
                                    <li class="botline"><a href="#"><strong>Radicaci&oacute;n</strong></a></li>
                                </ul>
                            </a>
                        </li>
                        ...
                        <li class="border-b">
                            <div class="menuUserNom">
                                <?= $_SESSION['usua_nomb'].' |' ?>
                            </div>
                        </li>
                        <li class="">
                            <div class="menuUserDepe">
                                <?= $_SESSION['depe_nomb'] ?></span>
                            </div>
                        </li>
                    </ul>
                </nav>
        ...
        <iframe id='leftFrame' name="leftFrame" src='correspondencia.php?<?= session_name() . "=" . session_id() ?>&fechah=<?= $fechah ?>' style="visibility: hidden; height: 121px;" onload="topMenuLoad(this)" ></iframe>
